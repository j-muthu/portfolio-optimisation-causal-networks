...
\textbf{(iii) Cheap directed baselines exist.} A ridge-regularised VAR(1)
coefficient matrix is a Granger-causal \cite{granger1969investigating}
directed graph obtainable in closed form; it is deterministic,
assumption-light, and serves as the ``is expensive discovery even needed?''
comparator. (A non-linear extension, NTS-NOTEARS \cite{sun2023ntsnotears},
