...
Because Q hinges on what the \emph{orientations} contribute, the design
carries two further graph sources that perturb exactly that ingredient;
...
is not guaranteed acyclic, which the allocators handle honestly
...
shock propagation fails --- which is precisely the dissociation
