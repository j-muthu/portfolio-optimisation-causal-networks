...
the pre-registered downstream ablation of
...
and zero refits (a key miss halts the run rather than silently refitting a
subtly different graph), at ${\approx}40$ seconds per backtest instead of
