...
\paragraph{\skelsem{} --- structural covariance.} Clustering as in \skelsamp{} --- the
...
$\Sigma_{\mathrm{struct}}$ (\orientsem{}). This is the most direct answer to the
...
\begin{table}[t]
  ...
  \begin{tabular}{l l l l}
    ...
    \skelsem{}            & graph embedding      & $\Sigma_{\mathrm{struct}}$ & allocation step \\
    \orientsamp{}            & topological order    & sample & ordering step \\
    \orientsem{}           & topological order    & $\Sigma_{\mathrm{struct}}$ & both steps \\
    \midrule
