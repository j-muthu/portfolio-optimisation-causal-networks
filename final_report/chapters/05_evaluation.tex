...
Table~\ref{tab:decomp}), with D2s reaching $+0.036$ at two years. Of the 40
graph-versus-\textsc{corr} cells --- five graph-consuming allocators, both
...
\begin{figure}[tbp]
  ...
  \caption{The fixed-graph orientation effect: $\Delta$Sharpe of each
    ...
    twelve DYNOTEARS contrasts are positive (D1 starred at two years); the
...
$\tau\in\{0,0.01,0.05,0.10\}$ leaves the treatment flat-to-better (D2:
...
allocator collapses (D1 $=0.352$; gap $-0.060$,
...
cloud's maximum} --- the headline allocators D0, D1 and D2s comfortably so
