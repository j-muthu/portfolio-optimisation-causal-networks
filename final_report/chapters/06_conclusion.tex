...
\begin{enumerate}[itemsep=2pt]
  \item \textbf{The total gain is stable across horizons.} Replacing the
        ...
        $+0.032$ (D1 $-$ \textsc{corr}; $p=0.43$--$0.12$) at every window,
        rising to $+0.036$ for D2s at two years; 36 of 40
  ...
  \item \textbf{Its composition shifts with the window.} The skeleton's
        ...
        to the estimation horizon}, not level: D1 ($0.395$--$0.415$) and
        D2s ($0.399$--$0.419$) are strong at every window while the
        skeleton-only allocator spans $0.372$--$0.403$, the increment is
        invariant to costs up to 20\,bps and to the graph's sparsity
        threshold, and D2s and D1 at the 18-month window attain the two
  ...
  \item \textbf{Nothing survives family-wise correction against honest
        ...
        weak HSP baseline ($p=\rsSpaConsistent$); against the \textsc{corr}
...
orientation-blind controls themselves disagree (D0s $-$ D0 $= +0.025$,
