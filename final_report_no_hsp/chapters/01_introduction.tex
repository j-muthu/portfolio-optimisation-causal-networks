...
\begin{itemize}[itemsep=2pt, topsep=3pt]
  \item \textbf{The decomposition (the answer to the research question).}
    ...
    horizons ($+0.018$ to $+0.032$ net Sharpe for \skelsem{}), worth
...
stable across estimation horizons, but its source shifts: the skeleton
pays most clearly near the conventional one-year window, while the
orientations pay at every horizon. Family-wise, support reaches
conventional significance only under the narrower reported family, at the
longest horizons, marginally.} The contribution is the allocator family
