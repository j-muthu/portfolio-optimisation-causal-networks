...
\begin{enumerate}[itemsep=2pt]
  \item \textbf{The total gain is stable across estimation windows.} Replacing the
  ...
  \item \textbf{Its composition shifts with the window.} The skeleton's
        ...
        to the estimation window, not level: \skelsem{}
        ($0.395$--$0.415$) and
  ...
  \item \textbf{The shapes carry qualifications, and the mechanism
        ...
        the one at long estimation windows
