...
($\Sigma_{\mathrm{SEM}}$) $0.240/0.259/0.322/0.297$. All twelve cells
...
\begin{table}[h]
  ...
  \caption{Transaction-cost sweep (DYNOTEARS): net Sharpe by one-way cost.
    The covariance-channel increment (\skelsem{}$-$\skelsamp{}) is
    cost-invariant at both windows; the ordering-route increment
    (\orientsem{}$-$\skelsamp{}) is cost-invariant at two years but erodes
    from $+0.004$ to $0.000$ across the sweep at the one-year window,
    \orientsem{} carrying the family's highest turnover.
