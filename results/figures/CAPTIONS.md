...
levels survive deflation, but the correlation baseline V0 is retained in the MCS,
so no causal variant is established as beating it once the search is corrected
for. Values from `results/robust_stats.csv` (`scripts/robust_stats.py`).*
